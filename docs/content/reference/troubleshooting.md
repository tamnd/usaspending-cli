...
Most of these come down to network reality or how usaspending serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

usaspending rate-limits like any public site. usaspending already paces
...
Where a surface is gated, usaspending reads a cookie or token you supply
...
`usaspending`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what usaspending actually did
