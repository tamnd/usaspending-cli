...
```
usaspending <command> [arguments] [flags]
```

Run `usaspending <command> --help` for the full flag list on any command. This
...
per operation you declare in `usaspending/domain.go`.
