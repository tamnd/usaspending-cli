...
// HTTP behaviour is covered in usaspending_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "usaspending://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("usaspending", "about")
	if err != nil || got.String() != "usaspending://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want usaspending://page/about", got.String(), err)
	}
}
